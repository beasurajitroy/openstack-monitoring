...
function (Settings) {
  ...
  /* 
    datasources: {
      influxdb: {
        type: 'influxdb',
        url: "http://ndc-dashboardinfra01.prod.gecsroy.com/db/portaldb", 
        username: 'root',
        password: 'root',
      },
      grafana: {
        type: 'influxdb',
        url: "http://ndc-dashboardinfra01.prod.gecsroy.com/db/grafana",
        username: 'root',
        password: 'root',
        grafanaDB: true,
      },
...
*/
    ...
    datasources: {
      influxdb: {
        type: 'influxdb',
        url: "http://edc-dashboardinfra01.prod.gecsroy.com/db/portaldb",
        username: 'root',
        password: 'root',
      },
      grafana: {
        type: 'influxdb',
        url: "http://edc-dashboardinfra01.prod.gecsroy.com/db/grafana",
        username: 'root',
        password: 'root',
        grafanaDB: true,
      },
      graphite: {
        type: 'graphite',
        url: "http://esm-graphite.prod.sroy.com",
        render_method: 'GET'
      },
      elasticsearch: {
        type: 'elasticsearch',
        url: "http://dfw-mon7.prod.sroy.com:9200",
        index: 'grafana-dash',
        grafanaDB: true,
      }
    },
