...
<tr>
      ...
      <?php  
         ...
         foreach ($clouds as $value) {
            ...
            $request_down = "http://esm-graphite.prod..com/render?target=$value.openstack.Hypervisors-nova-compute-DOWN&format=raw&from=-10mins";
            $response_down = file_get_contents($request_down);  

            $request_up = "http://esm-graphite.prod..com/render?target=$value.openstack.Hypervisors-nova-compute-UP&format=raw&from=-10mins";
...
<tr>
      ...
      <?php  
         ...
         foreach ($clouds as $value) {
            ...
            $request = "http://esm-graphite.prod..com/render?target=$value.openstack.Controller-nova-conductor-DOWN&format=raw&from=-15mins";
...
<tr>
      ...
      <?php  
         ...
         foreach ($clouds as $value) {
            ...
            $request = "http://esm-graphite.prod..com/render?target=$value.openstack.Controller-nova-scheduler-DOWN&format=raw&from=-15mins";
            $response = file_get_contents($request);  
...
<br><br><br><br>
<table class="legend">
<tr><td><img src='circle_green.png' /></td><td>Metrics is in Good State.</td></tr>
<tr><td><img src='circle_red.png' /></td><td>Metrics is in Bad State, Need immediate attention..!</td></tr>
<tr><td><img src='circle_yellow.png' /></td><td>Metrics is in Notify State.</td></tr>
<tr><td><img src='circle_grey.png' /></td><td>No values returned.</td></tr>
</table>

<footer align='center'> Copyright @ IAAS Operations </footer>
